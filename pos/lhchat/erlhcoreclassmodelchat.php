...
// Propiedad kanban_id
$def->properties['kanban_id'] = new ezcPersistentObjectProperty();
$def->properties['kanban_id']->columnName = 'kanban_id';
$def->properties['kanban_id']->propertyName = 'kanban_id';
